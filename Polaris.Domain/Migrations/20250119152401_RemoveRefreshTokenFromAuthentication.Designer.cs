...
namespace Polaris.Domain.Migrations
{
    ...
    [Migration("20250119152401_RemoveRefreshTokenFromAuthentication")]
    partial class RemoveRefreshTokenFromAuthentication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Polaris.Domain.Entity.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Polaris.Domain.Entity.RefreshToken", b =>
                {
                    b.HasOne("Polaris.Domain.Entity.Authentication", "AuthenticationNavigation")
                        .WithMany("RefreshTokenNavigation")
            ...
            modelBuilder.Entity("Polaris.Domain.Entity.Authentication", b =>
                {
                    b.Navigation("RefreshTokenNavigation");
                });
